...
// STL-compliant container compatible with std::set but with linear time insert and constant
// time random access.
//
...
public:
    ...
    RandomAccessSet(const std::size_t,
                    const Comparison& = Comparison(),
                    const Allocator&  = Allocator());
    RandomAccessSet(const Comparison& = Comparison(), const Allocator& = Allocator());
    template <class Iterator>
    RandomAccessSet(Iterator,
                    Iterator,
                    const Comparison& = Comparison(),
                    const Allocator&  = Allocator());
    ...
    const Vector& get_container() const;
    Vector&       get_container();
...
inline RandomAccessSet<Key, Comparison, Allocator>::RandomAccessSet(
    const Comparison& comparison, const Allocator& allocator)
...
template <class Key, class Comparison, class Allocator>
inline RandomAccessSet<Key, Comparison, Allocator>::RandomAccessSet(
    const std::size_t reserveSize, const Comparison& comparison, const Allocator& allocator)
    : vector_(allocator), compare_(comparison)
{
...
template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::pointer
RandomAccessSet<Key, Comparison, Allocator>::data()
{
    return vector_.data();
}

template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::const_pointer
RandomAccessSet<Key, Comparison, Allocator>::data() const
{
    return vector_.data();
}

template <class Key, class Comparison, class Allocator>
inline bool RandomAccessSet<Key, Comparison, Allocator>::empty() const
{
...
template <class Key, class Comparison, class Allocator>
template <class Iterator>
inline void RandomAccessSet<Key, Comparison, Allocator>::insert(Iterator first, Iterator last)
{
...
template <class Key, class Comparison, class Allocator>
inline void RandomAccessSet<Key, Comparison, Allocator>::erase(
    typename RandomAccessSet<Key, Comparison, Allocator>::iterator position)
{
...
template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::size_type
RandomAccessSet<Key, Comparison, Allocator>::erase(const key_type& x)
{
    iterator i = find(x);
    if (i != vector_.end())
    {
...
template <class Key, class Comparison, class Allocator>
inline void RandomAccessSet<Key, Comparison, Allocator>::clear()
{
    vector_.clear();
}
...
template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::const_iterator
RandomAccessSet<Key, Comparison, Allocator>::find(const key_type& value) const
{
...
template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::iterator
RandomAccessSet<Key, Comparison, Allocator>::find(const key_type& value)
{
...
template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::size_type
RandomAccessSet<Key, Comparison, Allocator>::count(const key_type& value) const
{
    if (find(value) == end())
    {
        return 0;
...
template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::const_iterator
RandomAccessSet<Key, Comparison, Allocator>::lower_bound(const key_type& value) const
{
...
template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::iterator
RandomAccessSet<Key, Comparison, Allocator>::lower_bound(const key_type& value)
{
    return std::lower_bound(vector_.begin(), vector_.end(), value, compare_);
}
...
template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::const_iterator
RandomAccessSet<Key, Comparison, Allocator>::upper_bound(const key_type& value) const
{
...
template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::iterator
RandomAccessSet<Key, Comparison, Allocator>::upper_bound(const key_type& value)
{
    return std::upper_bound(vector_.begin(), vector_.end(), value, compare_);
}

template <class Key, class Comparison, class Allocator>
inline std::pair<typename RandomAccessSet<Key, Comparison, Allocator>::const_iterator,
                 typename RandomAccessSet<Key, Comparison, Allocator>::const_iterator>
RandomAccessSet<Key, Comparison, Allocator>::equal_range(const key_type& value) const
{
    return std::equal_range(vector_.begin(), vector_.end(), value, compare_);
}

template <class Key, class Comparison, class Allocator>
inline std::pair<typename RandomAccessSet<Key, Comparison, Allocator>::iterator,
                 typename RandomAccessSet<Key, Comparison, Allocator>::iterator>
RandomAccessSet<Key, Comparison, Allocator>::equal_range(const key_type& value)
{
    return std::equal_range(vector_.begin(), vector_.end(), value, compare_);
}
...
template <class Key, class Comparison, class Allocator>
inline void RandomAccessSet<Key, Comparison, Allocator>::reserve(std::size_t n)
{
    return vector_.reserve(n);
}

template <class Key, class Comparison, class Allocator>
inline const typename RandomAccessSet<Key, Comparison, Allocator>::Vector&
RandomAccessSet<Key, Comparison, Allocator>::get_container() const
{
    return vector_;
}

template <class Key, class Comparison, class Allocator>
inline typename RandomAccessSet<Key, Comparison, Allocator>::Vector&
RandomAccessSet<Key, Comparison, Allocator>::get_container()
{
    return vector_;
}
